            ...
            <tbody>
                ...
                while ($array = mysqli_fetch_array($buscar)) {
                    ...
                    <tr>
                        ...
                        <td><?= $categoria ?></td>
                        <td><?= $fornecedor ?></td>
                        <td><a href="editar_produtos.php?id=<?= $id ?>" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a> <a href="excluir_produtos.php?id=<?= $id ?>" class="btn btn-danger btn-sm" role="button"><i class="fas fa-trash"></i></a></td>
                    </tr>
                <?php } ?>
            </tbody>
        </table>
