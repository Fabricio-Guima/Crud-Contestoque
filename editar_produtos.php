        ...
        <div class="container">
            ...
            <form method="POST" action="atualizar_produtos.php">
                <div class="form-group">
                    ...
                    <input type="number" name="nroproduto" class="form-control" value="<?= $nroproduto ?>" disabled>
                    <input type="number" name="id" class="form-control d-none" value="<?= $id ?>">
                </div>

                <div class="form-group">
                    <label>Nome do Produto</label>
                    <input type="text" name="nomeproduto" class="form-control" value="<?= $nomeproduto ?>">
                </div>
                ...
                <div class=" form-group">
                    ...
                    <select class="custom-select" name="categoria" value="<?= $categoria ?>">
                ...
                <div class=" form-group">
                    ...
                    <select class="custom-select" name="fornecedor" value="<?= $fornecedor ?>">
