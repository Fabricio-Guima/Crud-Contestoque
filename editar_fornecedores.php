...
<body>
    ...
    <section id="principal">
        ...
        <div class="container">
            ...
            <form method="POST" action="atualizar_fornecedores.php">
                <div class="form-group">
                    <label>ID do Fornecedor</label>
                    <input type="number" name="id_fornecedor" class="form-control" value="<?= $id ?>" disabled>
                    <input type="number" name="id" class="form-control d-none" value="<?= $id ?>">
                </div>

                <div class="form-group">
                    <label>Nome do Fornecedor</label>
                    <input type="text" name="nome_fornecedor" class="form-control" value="<?= $nomefornecedor ?>">
                </div>
