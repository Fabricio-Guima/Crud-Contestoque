...
<body>
    ...
    <div class="container" id="principal">
        ...
        <form method="POST" action="inserir_categorias.php">

            <div class="form-group">
                <label>Categoria</label>
                <input type="text" name="categoria" class="form-control" placeholder="Digite a categoria do produto" autocomplete="off" required>
            </div>
